/* =============================================
   pos.js - نقطة البيع (إصدار نهائي مكتمل)
   ============================================= */
'use strict';
...
const POS = {
    ...
    addToCartFromModal() {
        ...
        const price = +this.el.selectedPrice?.value || 0; if (price < 0) { alert('السعر لا يمكن أن يكون سالبًا'); return; }
    ...
    async resumeInvoice(id) {
        ...
        try {
            ...
            this.closeModal('heldInvoicesModal'); this.showToast('تم تحميل الفاتورة المعلقة');
